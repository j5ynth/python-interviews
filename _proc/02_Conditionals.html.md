---
description: conditionals and logical thinking
output-file: conditionals.html
title: Chapter 2 - Making Decisions
...
::: {#f8aa534e-0d00-465e-8300-1fbe1753149e .cell}
``` {.python .cell-code}
score = 80
...
::: {#c653d796-ddf8-4c5f-801f-95b4ba7fba94 .cell}
``` {.python .cell-code}
score = 79
...
::: {#5ef8582e-1239-42d8-a0fb-0da21f6857fd .cell}
``` {.python .cell-code}
score = 75
...
::: {#a19f65e8-a19b-4283-897b-d407394b2741 .cell}
``` {.python .cell-code}
math_score = 80
passed_english = True
...
::: {#c2ea3ab0-320a-439c-b99f-d55abc5f34b7 .cell}
``` {.python .cell-code}
colors = []
